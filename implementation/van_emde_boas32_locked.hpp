 ...
 * This implementation here is a naive baseline version where every operation is locked with a mutex.
 * 
 * You may define VEB_32_USE_BYTELL to use ska::bytell_hash_map by Malte Skarupke instead of the
 * specialized hash table. Furthermore, you may define VEB_32_LOCKED_USE_STD_MUTEX to use
...
#ifndef VEB_32_LOCKED_USE_STD_MUTEX
...
public:
    ...
    T locate(const T sValue) const noexcept {
        ...
        #ifdef VEB_32_LOCKED_USE_STD_MUTEX
